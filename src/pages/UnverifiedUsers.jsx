...
import { FaEdit, FaTrash, FaCheckCircle, FaTimesCircle, FaUserTimes } from 'react-icons/fa';
...
const UnverifiedUsers = () => {
    ...
    const fetchUsers = async () => {
        try {
            ...
            const unverifiedOnly = formattedUsers.filter(u => u.verificationStatus !== 'Verified');
            setUsers(unverifiedOnly);
            setFilteredUsers(unverifiedOnly);
        } catch (error) {
    ...
    const handleUpdateVerification = async () => {
        ...
        // If changed to Verified, remove from this list?
        ...
        <AdminLayout>
            <div className="p-4 md:p-6 bg-[#F4F6F9] min-h-screen">
                <div className="bg-[#28a745] text-white p-4 rounded-t-md shadow-sm">
                    <h1 className="text-xl font-normal">Unverified Users</h1>
                </div>
                                ...
                                {loading ? (
                                    ...
                                    filteredUsers.map((user) => (
                                        <tr key={user.id} className="hover:bg-gray-50 text-[13px] text-gray-600">
                                            ...
                                            <td className="p-3 border border-gray-200 font-medium text-gray-800 align-top">{user.name}</td>
                                            ...
                                            <td className="p-3 border border-gray-200 align-top">
                                                <div className="flex flex-col items-start gap-1">
                                                    <span className={`flex items-center gap-1 font-bold text-[#dc3545]`}>
                                            ...
                                            <td className="p-3 border border-gray-200 align-top">
                                                <div className="flex flex-col gap-1 min-w-[100px]">
                                                    ...
                                                    <div className="h-px bg-red-500 w-10"></div>
                                                    <div className="flex flex-col text-[11px]">
                                                        <span className="text-gray-700">{(Number(user.earningBalance) + 1.36).toFixed(2)} -</span>
                                    ...
                                    <tr>
                                        <td colSpan="13" className="text-center py-20">
                                            <div className="flex flex-col items-center justify-center gap-3">
                                                ...
                                                <h3 className="text-lg font-medium text-gray-900">No Unverified Users Found</h3>
                                                <p className="text-gray-500 text-sm">Great! It seems all users are verified or there are no unverified users.</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
